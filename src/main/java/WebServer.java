...
public class WebServer {
    ...
    public static void main(String args[]) throws Exception {
        ...
        final GetSessionUseCase getSessionUseCase = new GetSessionService(sessionPort);
        final SetSessionUseCase setSessionUseCase = new SetSessionService(sessionPort);
