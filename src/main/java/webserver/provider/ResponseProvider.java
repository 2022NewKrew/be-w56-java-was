...
public class ResponseProvider {
    ...
    public static HttpResponse responseStaticResource(DataOutputStream dos, String path) {
        try {
    ...
    public static HttpResponse responseClientException(DataOutputStream dos, WebServerException e) {
    ...
    public static HttpResponse responseServerException(DataOutputStream dos, Exception e) {
    ...
    private static HttpResponse response401Unauthorized(DataOutputStream dos, Exception e) {
