...
public class HttpRequestUtils {
	...
	public static Map<String, String> parseReqFirstLine(String line) {
	...
	public static Map<String, String> parseUrl(String url) {
		...
		result.put("path", tokens[0].toLowerCase());
		if (tokens.length != 1) {
			result.put("parameters", tokens[1]);
		}
		return result;
	}

	public static String parseUrlRootPath(String url) {
		String[] tokens = url.trim().split("/");
		if (tokens.length == 0) {
			return "/";
		}
