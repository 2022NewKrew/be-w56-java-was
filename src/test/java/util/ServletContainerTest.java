...
public class ServletContainerTest {
    ...
    @Test
    void getTest() throws InvocationTargetException, IllegalAccessException, IOException {
    ...
    @Test
    void postTest() throws InvocationTargetException, IllegalAccessException, IOException {
