...
public class HttpRequestUtilsTest {
    ...
    public void parseQueryString() {
        ...
        Map<String, String> parameters = HttpRequestUtils.parseData(queryString);
        assertThat(parameters.get("userId")).isEqualTo("javajigi");
        assertThat(parameters.get("password")).isNull();

        queryString = "userId=javajigi&password=password2";
        parameters = HttpRequestUtils.parseData(queryString);
        assertThat(parameters.get("userId")).isEqualTo("javajigi");
    ...
    public void parseQueryString_null() {
        Map<String, String> parameters = HttpRequestUtils.parseData(null);
        assertThat(parameters.isEmpty()).isTrue();

        parameters = HttpRequestUtils.parseData("");
        assertThat(parameters.isEmpty()).isTrue();
